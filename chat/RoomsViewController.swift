...
class RoomsViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        DBManager.manager.observeRommAdded {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //making sure we are going now to chat screen, from a cell, and the tableview knows its index path
        //using indexPath we can extract the Room object and set it to tje coming chatVC instance
